...
namespace DanishAddressComponent
{
    ...
    {
        private const string JavaScriptSetupAutoComplete = "danishAddress.activateAddressComponent";
        private const string JavaScriptDestroyAutoComplete = "danishAddress.destroyComponent";
        ...
        [Inject]
        protected IDAWAAddressDTOBOConverter? dtoboConverter { get; set; }
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            if (firstRender is true)
            {
                ...
                await JSRuntime.InvokeVoidAsync(JavaScriptSetupAutoComplete, _instanceReference, ComponentId, methodName, adrId, OnlyAccessAddresses,
        ...
        {
            await JSRuntime.InvokeVoidAsync(JavaScriptDestroyAutoComplete, ComponentId);
        }
        ...
        {
            if (dtoboConverter is not null && Address is not null)
            {
